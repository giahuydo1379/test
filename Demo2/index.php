...
<body>
	...
	<?php
	require('./model/Paginator.php'); // khuc nay la em goi cai file paginatookr,anh tam bo qua no di
	use util\Paginator; 
			...
			<table id="t01" border="2px" align="center" class = "table">
				...
				if(isset($_GET['show'])){
					...
					$showPage = 5;
                                ...
                                // khuc nay là khai bao cac thong tin cua database
				$servername = "localhost";
				$username = "root";
				$password = "";
				$dbname = "db549595537";

				// Create connection, cai nay tao ket noi
				...
				$begin = ($paginator->pageIndex - 1)* $paginator->totalRecordOnepage ;
                                // cai nay la cau lenh SQL, mà sao cau lệnh này dài hơn trong w3scholl với bên anh thông v,bỏ qua cũng dc
